<template>
  <div class="w-full h-full bg-cyan-600 text-white overflow-x-scroll bg-[url(/img/boloto.jpg)] bg-center bg-cover bg-no-repeat fixed inset-0">
    <div class="sticky top-0 flex justify-between p-4 z-10">
      <div class="navbar bg-teal-600 shadow-md mr-4 rounded-md shadow-emerald-900 inset-shadow-xs inset-shadow-emerald-500 opacity-90 z-10">
        <div class="navbar-start">
          <div class="dropdown">
            ...
            <ul
                tabindex="0"
                class="menu menu-sm dropdown-content bg-teal-600 rounded-box z-1 mt-3 w-52 p-2 shadow">
              <li><a>Доставка воды от Романа</a></li>
              <li>
                <a>Parent</a>
                <ul class="p-2">
                  <li><a>Submenu 1</a></li>
          ...
          <a class="btn btn-ghost border-none  hover:inset-shadow-xs hover:bg-teal-700 m-1 text-xl">Доставка воды от Романа</a>
        </div>
      ...
      <div class="flex justify-between bg-teal-600 lg:menu-horizontal shadow-md ml-4 p-4 rounded-md shadow-emerald-900 inset-shadow-xs inset-shadow-emerald-500 opacity-90 z-10">
        ...
        <div class="flex space-x-4">
          ...
          <details class="dropdown dropdown-end">
            <summary class="btn btn-ghost border-none shadow-md shadow-emerald-800 hover:shadow-emerald-900 hover:bg-emerald-700 m-1 bg-emerald-500 ">Профиль
          ...
          <details class="dropdown ">
            <summary class="btn btn-ghost border-none shadow-md shadow-emerald-800 hover:shadow-emerald-900 hover:bg-emerald-700 m-1 bg-emerald-500">
    ...
    <slot/>
    <footer class="flex justify-between bg-teal-600 text-neutral-content rounded-t-lg p-10 ml-4 mr-4 shadow-md shadow-emerald-900 inset-shadow-xs inset-shadow-emerald-500 opacity-90">
      <aside>
        <svg
            width="50"
            height="50"
