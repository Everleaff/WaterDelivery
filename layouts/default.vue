<template>
  <div class="bg-cyan-600 bg-[url(/img/boloto.jpg)] bg-center bg-cover bg-no-repeat h-screen ">
    <div class="text-white flex-row h-full" >
...
<!--            </div>-->
      ...
      <slot/>
      <footer class="flex  w-full  justify-between bg-teal-600 text-neutral-content rounded-t-lg p-10 opacity-90">
        <aside>
          <svg
              width="50"
              height="50"
